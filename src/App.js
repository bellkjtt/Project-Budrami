...
function AnimatedRoutes() {
  ...
  const [cards, setCards] = useState([
    ...
    { id: 1, title: "가족과 함께한 단단한 시간들", subtitle: "위기 속에서 하나 된 것", image: image3, video:Video3, text:"중년이 되면서 내 삶의 중심은 가족이었다. 아이들이 자라나는 모습을 지켜보며 “너희는 무엇이든 할 수 있어”라는 말로 자신감을 키워주었다. 큰아들의 대학 합격은 지금도 가슴 벅찬 기억이다. 남편의 사업 실패로 어려움을 겪었지만, 가족이 힘을 합쳐 극복해냈다. 중년이 되며 삶에 여유를 찾고, 부모님을 더 잘 돌보지 못한 아쉬움이 남지만, 가족을 위해 헌신했던 시간이 나를 더 강하게 만들었다." },
    { id: 2, title: "감사 속에 피어난 아름다움", subtitle: "이렇게 새로운 시작", image: image2, video:Video2, text:"노년이 된 지금, 나는 산책을 하며 꽃꽂이를 배우며 여유를 즐긴다. 하고 싶은 것을 할 수 있는 자유가 기쁘지만, 건강이 걱정되기도 한다. 오랜 친구가 세상을 떠났을 때 마음이 아팠지만, 남은 친구들과 더 돈독해졌다. 여전히 건강하게 손주들의 결혼을 보고 싶고, 여행을 꿈꾸며 남은 시간을 감사하게 살고 있다. 내 인생을 한 마디로 표현하면 ‘사랑으로 일군 풍요로운 삶’이다." }
  ]);
